...
class DDAddressCountryListPop: DDView {
...
//            make.top.equalTo(mTableView.snp.bottom)
//            make.left.right.equalToSuperview()
...
extension DDAddressCountryListPop {
    func _bindView() {
...
extension DDAddressCountryListPop: UITableViewDelegate, UITableViewDataSource {
