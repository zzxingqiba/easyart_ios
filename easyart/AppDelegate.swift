...
//        let searchVC = SearchVC()
        ...
        let meVC = MeVC()
        let v4 = BaseNavigationController(rootViewController: meVC)

        v1.tabBarItem = ESTabBarItem.init(BaseTabBarItemContentView(textColor: UIColor.dd.color(hexValue: 0x2f323e)), title: nil, image: UIImage(named: "tab1"), selectedImage: UIImage(named: "tab_selected1"))
        v2.tabBarItem = ESTabBarItem.init(BaseTabBarItemContentView(textColor: UIColor.dd.color(hexValue: 0x2f323e)), title: nil, image: UIImage(named: "tab2"), selectedImage: UIImage(named: "tab_selected2"))
        v3.tabBarItem = ESTabBarItem.init(BaseTabBarItemContentView(textColor: UIColor.dd.color(hexValue: 0x2f323e)), title: nil, image: UIImage(named: "tab5"), selectedImage: UIImage(named: "tab_selected5"))
        v4.tabBarItem = ESTabBarItem.init(BaseTabBarItemContentView(textColor: UIColor.dd.color(hexValue: 0x2f323e)), title: nil, image: UIImage(named: "tab4"), selectedImage: UIImage(named: "tab_selected4"))
...
extension AppDelegate {
    func application(_ app: UIApplication, open url: URL, options: [UIApplication.OpenURLOptionsKey : Any] = [:]) -> Bool {
        ...
        if url.scheme == "speakpal" {
            ...
            //谷歌登陆
            let googleHandel = GIDSignIn.sharedInstance.handle(url)
            return googleHandel
        }
    }
}
