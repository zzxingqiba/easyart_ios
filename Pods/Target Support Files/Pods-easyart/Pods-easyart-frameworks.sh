...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/DDFileBrowser/DDFileBrowser.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/DDKitFPS/DDKitFPS.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/DDKitSwift/DDKitSwift.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/DDKitSwift_FPS/DDKitSwift_FPS.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/DDKitSwift_FileBrowser/DDKitSwift_FileBrowser.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/DDKitSwift_Netfox/DDKitSwift_Netfox.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/DDKitSwift_Ping/DDKitSwift_Ping.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/DDKitSwift_UserDefaultManager/DDKitSwift_UserDefaultManager.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/DDUserDefaultManager/DDUserDefaultManager.framework"
