//
//  SettleInUpdateIDCoverView.swift
//  easyart
//
...
class SettleInUpdateCoverView: DDView {
    var imageUrl: String? {
        didSet {
    ...
    //MARK: UI
    lazy var mBGImageView: UIImageView = {
        let imageView = UIImageView(image: UIImage(named: "cover-px"))
        return imageView
    }()
    ...
    lazy var mAddImageView: UIImageView = {
        let imageView = UIImageView(image: UIImage(named: "icon-add-bold"))
        return imageView
    }()
