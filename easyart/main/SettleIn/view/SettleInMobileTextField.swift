//
//  SettleInMobileTextField.swift
//  easyart
//
//  Created by Damon on 2025/2/11.
//

import UIKit

class SettleInMobileTextField: DDView {
    var errorTitle = ""
    var mobilePre = "" {
        didSet {
            self.mPreLabel.text = mobilePre
        }
    }
    ...
    lazy var mTextField: DDTextFieldView = {
        ...
        textField.mTextField.keyboardType = .numberPad
        return textField
    }()
